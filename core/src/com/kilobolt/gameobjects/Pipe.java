...
public class Pipe extends Scrollable {
    ...
    public void update(float delta) {
        ...
        // Our skull width is 24. The bar is only 22 pixels wide. So the skull must
        // be shifted by 1 pixel to the left (so that the skull is centered with respect to its bar)
        // The shift is equivalent to: (SKULL_WIDTH - width) / 2

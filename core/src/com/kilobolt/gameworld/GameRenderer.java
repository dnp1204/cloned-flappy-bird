...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        // Set a color to fill the screen with RGB and opacity of 1 (100%)
        ...
        // The birds and skulls need transparency, so we enable that again
        ...
        if (myWorld.isReady()) {
            ...
            // Draw text
            AssetLoader.font.draw(batcher, "" + myWorld.getScore(), (136 / 2) - (3 * score.length() - 1), 12);
        }
